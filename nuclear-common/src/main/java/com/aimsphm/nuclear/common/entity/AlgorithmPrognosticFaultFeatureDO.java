 ...
 */
@Data
@TableName("algorithm_prognostic_fault_feature")
@ApiModel(value = "征兆预测")
public class AlgorithmPrognosticFaultFeatureDO extends BaseDO {
    /**
     * 序列化时候使用
     */
    private static final long serialVersionUID = -7612398870118075311L;
