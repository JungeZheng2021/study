...
public class CommonUtil {
	...
	public static QueryWrapper initQueryWrapper(QueryObject dto) {
		QueryWrapper queryWrapper = new QueryWrapper<>();
		queryWrapper.setEntity(dto.getQueryObject());
		return queryWrapper;
	}
	public static HColumnQueryExtendBO buildQueryBo(String tagId, Long start, Long end) {
		...
		queryBO.setTableName(CommonConstant.HBASE_TABLE_NAME);
		queryBO.setFamily(CommonConstant.HBASE_CF);
