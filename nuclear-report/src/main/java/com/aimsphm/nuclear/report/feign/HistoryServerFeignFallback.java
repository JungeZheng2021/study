...
public class HistoryServerFeignFallback implements HistoryServerFeignClient {
    ...
    @Override
    public ResponseData<Map<String, HistoryDataWithThresholdVO>> listHistoryWithPointList(HistoryQueryMultiBO queryMultiBO) {
        return null;
    }


    @Override
    public ResponseData<Map<String, EventDataVO>> listDataWithPointList(HistoryQueryMultiBO queryMultiBO) {
        return null;
    }
}
