...
public final class PackageInfoConstant {
     ...
     * ------------------------------controller层单独配置--------------------------
     */
    public static String CONTROLLER_OUTPUT_ROOT_PATH = "/com/aimsphm/nuclear/" ;
    /**
     * controller根目录
     */
    public static String ROOT_PROJECT_CONTROLLER_PATH = "/nuclear-core" ;
    /**
     * 包路径(基础包路径)
     */
    public static String PACKAGE_ROOT = "com.aimsphm.nuclear" ;
    /**
     ...
     * 根路径
     */
    public static String ROOT_PROJECT_PATH = "/nuclear-common" ;
    /**
     * 输出基础包
     */
    public static String OUTPUT_ROOT_PATH = "/com/aimsphm/nuclear" ;
    /**
     * 配置你包路径下的子模块(例如：com.aimsphm.nuclear.common)
     * (例如：com.aimsphm.ext)
     */
     ...
     * controller的实体名称后缀
     */
    public static String CONTROLLER_CLASS_NAME = "Controller" ;
    /**
     * 扩展实现类名称
     */
