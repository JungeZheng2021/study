...
public class StreamTests {
    ...
    public void producer() throws InterruptedException {
        RedisClient redisClient = RedisClient.create("redis://192.168.16.28:6379");
        StatefulRedisConnection<String, String> connect = redisClient.connect();
        RedisCommands<String, String> stream = connect.sync();
        stream.xadd("stream_sms_send", "smsid", "10001", "content", "收到短信请回复");
        stream.xdel("stream_sms_send", "smsid");
